  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:20px">
        <h1 class="h1" style="color:#000;fontSize:26px;">企业台账管理平台注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='yuangong'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.bumen" class="input" type="text" placeholder="部门">
			   </div>
			 </div> -->
			<el-form-item label="部门" class="input" v-if="tableName=='yuangong'">
			  <el-input v-model="ruleForm.bumen" autocomplete="off" placeholder="部门" type="text" />
			</el-form-item>
																					<!-- <div v-if="tableName=='yuangong'" class="input-group">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='yuangong'">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='yuangong'">
			  <el-input v-model="ruleForm.shenfenzheng" autocomplete="off" placeholder="身份证" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.jiatingzhuzhi" class="input" type="text" placeholder="家庭住址">
			   </div>
			 </div> -->
			<el-form-item label="家庭住址" class="input" v-if="tableName=='yuangong'">
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20201224/bf0e1e7d54a545acb2f84e8e43e5a118.jpg");
		height: 100vh;
