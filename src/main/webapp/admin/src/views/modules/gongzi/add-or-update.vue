          ...
          <el-form-item class="input" label="基本工资" prop="jibengongzi">
              <el-input v-model="ruleForm.jibengongzi" 
                placeholder="基本工资" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="加班薪资" prop="jiabanxinzi">
          <el-input v-model="ruleForm.jiabanxinzi" 
              placeholder="加班薪资" clearable  :readonly="ro.jiabanxinzi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="加班薪资" prop="jiabanxinzi">
              <el-input v-model="ruleForm.jiabanxinzi" 
                placeholder="加班薪资" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="缺勤薪资" prop="queqinxinzi">
          <el-input v-model="ruleForm.queqinxinzi" 
              placeholder="缺勤薪资" clearable  :readonly="ro.queqinxinzi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="缺勤薪资" prop="queqinxinzi">
              <el-input v-model="ruleForm.queqinxinzi" 
                placeholder="缺勤薪资" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="高温补贴" prop="gaowenbutie">
          <el-input v-model="ruleForm.gaowenbutie" 
              placeholder="高温补贴" clearable  :readonly="ro.gaowenbutie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="高温补贴" prop="gaowenbutie">
              <el-input v-model="ruleForm.gaowenbutie" 
                placeholder="高温补贴" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工龄奖" prop="gonglingjiang">
          <el-input v-model="ruleForm.gonglingjiang" 
              placeholder="工龄奖" clearable  :readonly="ro.gonglingjiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工龄奖" prop="gonglingjiang">
              <el-input v-model="ruleForm.gonglingjiang" 
                placeholder="工龄奖" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  computed: {
                                                                                                                shifagongzi: {
                                                                                                                                                                                                                                                                                get: function () {
        return 0+parseFloat(this.ruleForm.jibengongzi)+parseFloat(this.ruleForm.jiabanxinzi)-this.ruleForm.queqinxinzi+parseFloat(this.ruleForm.gaowenbutie)+parseFloat(this.ruleForm.gonglingjiang) || ''
      }
    },
                      },
  created() {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jibengongzi = true;
            continue;
	            	            ...
	            	            if(o=='jiabanxinzi'){
            this.ruleForm.jiabanxinzi = obj[o];
	    this.ro.jiabanxinzi = true;
            continue;
          }
	            	            if(o=='queqinxinzi'){
            this.ruleForm.queqinxinzi = obj[o];
	    this.ro.queqinxinzi = true;
            continue;
          }
	            	            if(o=='gaowenbutie'){
            this.ruleForm.gaowenbutie = obj[o];
	    this.ro.gaowenbutie = true;
            continue;
          }
	            	            if(o=='gonglingjiang'){
            this.ruleForm.gonglingjiang = obj[o];
	    this.ro.gonglingjiang = true;
            continue;
          }
	            	            if(o=='shifagongzi'){
