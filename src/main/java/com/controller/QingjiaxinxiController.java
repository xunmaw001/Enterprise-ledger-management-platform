...
public class QingjiaxinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,QingjiaxinxiEntity qingjiaxinxi, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yuangong")) {
			qingjiaxinxi.setYuangonggonghao((String)request.getSession().getAttribute("username"));
		}
